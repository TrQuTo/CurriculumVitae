      ...
      <tbody v-if="cvLoaded">
        ...
        <tr class="fontsize">
          <td style="width: 250px">
            ...
            <span class="content">{{
              cv_tqtoan.personal_info.date_of_birth
            }}</span>
          </td>
              ...
              <tbody>
                ...
                <tr class="work-exp">
                  <td class="education">
                    <table class="table table-primary">
                      <template
                        v-for="edu in cv_tqtoan.education"
                        :key="edu.ID"
                      >
                        <tbody>
                          <tr>
                          ...
                          <tr>
                            <td>
                              <li style="list-style-type: disclosure-open">{{ edu.major }}</li>
                            </td>
                          </tr>
                          <tr>
                            <td><li style="list-style-type: circle; padding-left: 17px;">{{ edu.duration }}</li></td>
                          </tr>
                          <tr>
                            <td><li style="list-style-type: circle; padding-left: 17px;">{{ edu.summary }}</li></td>
                          </tr>
                        </tbody>
                      </template>
                    </table>
                  ...
                  <td class="skills">
                    <table class="table table-primary">
                      <template
                        v-for="skill in cv_tqtoan.skills"
                        :key="skill.ID"
                      >
                        <tbody>
                          <tr>
                          ...
                          <template
                            v-for="description_skill in skill.description_skills"
                            :key="description_skill.ID"
                          >
                            <tr>
                              <td v-if="skill.IsSoftSkills != 'true'">
                                <a>{{ description_skill.name_skills }}</a>
                              </td>
                              <td v-else>
                                <ul>
                            ...
                            <tr>
                              <td>
                                <ul
                                  v-for="desc_s in description_skill.description_skills"
                                  :key="desc_s.ID"
                                >
                                  <li>{{ desc_s }}</li>
                                </ul>
        ...
        skills: [
          {
            ...
            description_skills: [
              ...
              },
              {
                name_skills: "Server",
                description_skills: {
                  desc_s1: "Experienced of using Linux server, AWS, GG Cloud, Docker.",
                },
              },
            ],
          },
